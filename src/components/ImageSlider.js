...
export default function ImageSlider() {
  ...
  <div className="slideshow" data-transition="fade">
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/Dinning%20Area.jpg" alt='' />
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/kid's%20bedroom.jpg"alt='' />
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/kitchen_01.jpg"alt='' />
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/Living%20Room_01.jpg"alt='' />
      <label htmlFor="ss2-item-3" className="slideshow--nav slideshow--nav-previous">Go to slide 3</label>
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/Master_bedroom.jpg"alt='' />
    ...
    <div className="slideshow--item">
      <img src="http://www.thelaxmigroup.in/image/internal-amenities/study%20room%2002.jpg"alt='' />
      <label htmlFor="ss2-item-4" className="slideshow--nav slideshow--nav-previous">Go to slide 4</label>
      <label htmlFor="ss2-item-3" className="slideshow--nav slideshow--nav-next">Go to slide 3</label>
    </div>
  </div>
